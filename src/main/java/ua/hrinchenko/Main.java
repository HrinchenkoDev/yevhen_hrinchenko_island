...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. Завантажуємо налаштування (якщо ти використовуєш XML парсер, залиш цей рядок)
        // Якщо використовуєш звичайний клас Config або Enum, цей рядок не потрібен.
        Config.load("C:\\Users\\digdo\\Documents\\Java Projects\\TranningProject\\src\\main\\resources\\config.xml");
